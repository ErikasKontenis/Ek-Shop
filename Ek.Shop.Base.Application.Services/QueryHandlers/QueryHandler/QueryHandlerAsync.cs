...
{
    public abstract class QueryHandlerAsync<TCommand, TResult> : IQueryHandlerAsync<TCommand, TResult> where TCommand : ICommand
    {
        public abstract Task<ActionResult<TResult>> HandleAsync(TCommand command);
