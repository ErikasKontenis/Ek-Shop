...
{
    public class CategoryBreadcrumbMapperProfile : Profile
    {
        public CategoryBreadcrumbMapperProfile()
            : this("CategoryBreadcrumbProfile")
        { }

        protected CategoryBreadcrumbMapperProfile(string profileName)
            : base(profileName)
        {
