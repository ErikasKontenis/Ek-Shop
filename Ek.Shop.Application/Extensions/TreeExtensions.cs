...
namespace Ek.Shop.Application.Extensions
{
    ...
    public static class TreeExtensions
    {
        ...
        public static List<T> ListAllNodes<T>(this T node)
            where T : class, ITreeNode<T>
        {
            ...
            if (node.Children != null)
            {
                ...
                {
                    nodes.AddRange(child.ListAllNodes());
                }
            }
        ...
        /// <summary>
        /// Gets the last nodes of the given node. Note that the given node is included in the returned list.
        /// </summary>
        /// <param name="node">The forest of trees to get found last nodes.</param>
        public static IEnumerable<T> LastNodes<T>(this IEnumerable<T> trees)
            where T : class, ITreeNode<T>
        {
            List<T> lastNodeList = new List<T>();
            foreach (T n in trees.DepthFirstTraversalOfList())
            {
